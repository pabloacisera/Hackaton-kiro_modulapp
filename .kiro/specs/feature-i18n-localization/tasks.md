...
- [ ] TASK-i18n-4: Migration: add `locale` column to `orders`, `quotes`, `complaints`
  ...
  - Deliverable: `apps/api-core/src/migrations/<timestamp>_add_locale_to_records.ts`
...
- [ ] TASK-i18n-5: Middleware/decorator reads `X-Locale` header and persists to record
  ...
  - Deliverable: `apps/api-core/src/common/decorators/set-locale.decorator.ts`, `apps/api-core/src/common/decorators/__tests__/set-locale.decorator.spec.ts`
...
- [ ] TASK-i18n-6a: Email templates (purchase flow) in es/en — confirmation + receipt
  ...
  - Deliverable: `apps/api-core/src/modules/notifications-email/templates/es/purchase-confirmation.hbs`, `apps/api-core/src/modules/notifications-email/templates/en/purchase-confirmation.hbs`, `apps/api-core/src/modules/notifications-email/templates/es/purchase-receipt.hbs`, `apps/api-core/src/modules/notifications-email/templates/en/purchase-receipt.hbs`, `apps/api-core/src/modules/notifications-email/templates/__tests__/purchase-templates.spec.ts`
  - Depends on: TASK-i18n-4
  - Assigned to: unassigned
...
- [ ] TASK-i18n-6b: Email templates (quote/complaint flow) in es/en — quote sent, acceptance, rejection, postponement, expiration, complaint receipt
  ...
  - Deliverable: `apps/api-core/src/modules/notifications-email/templates/es/quote-sent.hbs`, `apps/api-core/src/modules/notifications-email/templates/en/quote-sent.hbs`, `apps/api-core/src/modules/notifications-email/templates/es/quote-acceptance.hbs`, `apps/api-core/src/modules/notifications-email/templates/en/quote-acceptance.hbs`, `apps/api-core/src/modules/notifications-email/templates/es/quote-rejection.hbs`, `apps/api-core/src/modules/notifications-email/templates/en/quote-rejection.hbs`, `apps/api-core/src/modules/notifications-email/templates/es/quote-postponement.hbs`, `apps/api-core/src/modules/notifications-email/templates/en/quote-postponement.hbs`, `apps/api-core/src/modules/notifications-email/templates/es/quote-expiration.hbs`, `apps/api-core/src/modules/notifications-email/templates/en/quote-expiration.hbs`, `apps/api-core/src/modules/notifications-email/templates/es/complaint-receipt.hbs`, `apps/api-core/src/modules/notifications-email/templates/en/complaint-receipt.hbs`, `apps/api-core/src/modules/notifications-email/templates/__tests__/quote-complaint-templates.spec.ts`
  - Depends on: TASK-i18n-4
  - Assigned to: unassigned
...
- [ ] TASK-i18n-7: `notifications-email` module selects template based on record `locale`
  ...
  - Deliverable: `apps/api-core/src/modules/notifications-email/notifications-email.service.ts` (modify), `apps/api-core/src/modules/notifications-email/__tests__/template-selection.spec.ts`
...
- [ ] TASK-i18n-integration: Integration tests for locale across all flows
  ...
  - Deliverable: `apps/api-core/src/modules/**/locale-flow.integration-spec.ts`
