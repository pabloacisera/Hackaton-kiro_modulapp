...
- [ ] TASK-notif-1: Migration for `admin_notifications` table + `notifications` module with central `notifyAdmins()`
  ...
  - Deliverable: `apps/api-core/src/modules/notifications/notifications.module.ts`, `apps/api-core/src/modules/notifications/entities/admin-notification.entity.ts`, `apps/api-core/src/modules/notifications/notifications.service.ts`, `apps/api-core/src/modules/notifications/notifications.service.spec.ts`, `apps/api-core/src/database/migrations/*_create_admin_notifications.ts`
  - Depends on: none
...
- [ ] TASK-notif-2: WebSocket Gateway (`@nestjs/websockets`) with JWT auth on handshake
  ...
  - Deliverable: `apps/api-core/src/modules/notifications/gateways/admin-notification.gateway.ts`, `apps/api-core/src/modules/notifications/gateways/admin-notification.gateway.spec.ts`
...
- [ ] TASK-notif-3: `GET /admin/notifications?read=&page=` endpoint
  ...
  - Deliverable: `apps/api-core/src/modules/notifications/controllers/notifications.controller.ts`, `apps/api-core/src/modules/notifications/controllers/notifications.controller.spec.ts`
...
- [ ] TASK-notif-4: `notification.mark_read` event (propagated to same admin multi-tab)
  ...
  - Deliverable: `apps/api-core/src/modules/notifications/gateways/admin-notification.gateway.ts` (updated), `apps/api-core/src/modules/notifications/gateways/admin-notification.gateway.spec.ts` (updated)
...
- [ ] TASK-notif-5: Integrate `notifyAdmins()` — direct-purchase flow
  ...
  - Deliverable: `apps/api-core/src/modules/direct-purchase/` (updated service file calling `notifyAdmins`)
...
- [ ] TASK-notif-6: Integrate `notifyAdmins()` — quotes flow
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/` (updated service file calling `notifyAdmins`)
...
- [ ] TASK-notif-7: Integrate `notifyAdmins()` — complaints flow
  ...
  - Deliverable: `apps/api-core/src/modules/complaints/` (updated service file calling `notifyAdmins`)
...
- [ ] TASK-notif-8: Integrate `notifyAdmins()` — low-stock alarm
  ...
  - Deliverable: `apps/api-core/src/modules/stock/` (updated service file calling `notifyAdmins`)
...
- [ ] TASK-notif-9: `controllers/useNotifications.ts` (socket + sound queue with debounce)
  ...
  - Deliverable: `apps/admin-dashboard/src/controllers/useNotifications.ts`, `apps/admin-dashboard/src/controllers/useNotifications.spec.ts`
  - Depends on: TASK-notif-2
  - Assigned to: unassigned
...
- [ ] TASK-notif-10: `views/NotificationBell` + `views/NotificationPanel`
  ...
  - Deliverable: `apps/admin-dashboard/src/views/NotificationBell.tsx`, `apps/admin-dashboard/src/views/NotificationPanel.tsx`
...
- [ ] TASK-notif-11: Sound asset selection + persisted on/off preference
  ...
  - Deliverable: `apps/admin-dashboard/src/assets/notification-sound.mp3`, `apps/admin-dashboard/src/controllers/useNotifications.ts` (updated with preference read/write)
...
- [ ] TASK-notif-12: Reconnection with backoff on WebSocket client
  ...
  - Deliverable: `apps/admin-dashboard/src/controllers/useNotifications.ts` (updated with reconnection logic)
  - Depends on: TASK-notif-9
  - Assigned to: unassigned
...
- [ ] TASK-notif-integration: Integration tests for WebSocket event delivery and mark_read sync
  ...
  - Deliverable: `apps/api-core/src/modules/notifications/**/*.integration-spec.ts`
