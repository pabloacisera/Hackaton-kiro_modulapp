...
- [x] TASK-quoteadmin-1: `GET /admin/quotes` endpoint with combined filters
  - Depends on: TASK-quoteB-2 (Quote entity)
  - Assigned to: unassigned
- [x] TASK-quoteadmin-2: `GET /admin/quotes/:id` endpoint with calculated timeline
  - Depends on: TASK-quoteadmin-1
  - Assigned to: unassigned
- [x] TASK-quoteadmin-3: `PATCH /admin/quotes/:id/postpone` endpoint + email to customer
  - Depends on: TASK-quoteadmin-1
  - Assigned to: unassigned
- [x] TASK-quoteadmin-4: `views/QuotesTable` with search/filters/pagination
  - Depends on: TASK-quoteadmin-1
  - Assigned to: unassigned
- [x] TASK-quoteadmin-5: `views/QuoteDetail` + `TimelineStatus` component
  - Depends on: TASK-quoteadmin-2
  - Assigned to: unassigned
- [x] TASK-quoteadmin-6: `views/PostponeQuoteModal`
  - Depends on: TASK-quoteadmin-3
  - Assigned to: unassigned

- [x] TASK-quoteadmin-test1: Unit tests for admin quote management logic
...
- [x] TASK-quoteadmin-test2: Integration tests for admin quote management
