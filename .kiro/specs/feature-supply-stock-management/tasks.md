...
- [x] TASK-stock-1: Database migration + `Supply` entity with domain rules
  ...
  - Deliverable: `apps/api-core/prisma/schema.prisma` (migration), `apps/api-core/src/domain/supply/Supply.ts`, `apps/api-core/src/domain/supply/SupplyStockChangeLog.ts`, `apps/api-core/src/domain/supply/LowStockAlertState.ts`
  - Depends on: none
...
- [x] TASK-stock-2: CRUD endpoints `/admin/supplies` with search, filters, and pagination
  ...
  - Deliverable: `apps/api-core/src/interface/http/controllers/SupplyController.ts`, `apps/api-core/src/application/use-cases/supply/` (CreateSupply, UpdateSupply, DeleteSupply, ListSupplies), `apps/api-core/src/infrastructure/prisma/repositories/SupplyRepository.ts`
...
- [x] TASK-stock-3: Excel parser with row-by-row validation + downloadable template + documentation
  ...
  - Deliverable: `apps/api-core/src/application/use-cases/supply/ExcelParser.ts`, `apps/api-core/src/application/use-cases/supply/__tests__/ExcelParser.spec.ts`, `apps/api-core/src/interface/http/controllers/SupplyController.ts` (template download endpoint), `docs/supply-template.md`, `apps/api-core/public/templates/supply-template.xlsx`
  - Depends on: TASK-stock-1
  - Assigned to: unassigned
...
- [x] TASK-stock-4: `POST /admin/supplies/import-excel` endpoint (preview without applying)
  ...
  - Deliverable: `apps/api-core/src/application/use-cases/supply/ImportSupplyExcel.ts`, `apps/api-core/src/interface/http/dto/ImportSupplyPreviewResponse.dto.ts`
...
- [x] TASK-stock-5: `POST /admin/supplies/import-excel/confirm` endpoint (apply + log)
  ...
  - Deliverable: `apps/api-core/src/application/use-cases/supply/ConfirmSupplyImport.ts`
...
- [x] TASK-stock-6: `GET /admin/supplies/export-excel` endpoint
  ...
  - Deliverable: `apps/api-core/src/application/use-cases/supply/ExportSupplyExcel.ts`
...
- [x] TASK-stock-7: BullMQ job `hourly-low-stock-check` with anti-fatigue alert logic
  ...
  - Deliverable: `apps/api-core/src/application/jobs/low-stock-check.job.ts`, `apps/api-core/src/application/use-cases/supply/LowStockAlertState.ts` (update logic), `apps/api-core/src/application/use-cases/supply/__tests__/LowStockAlertState.spec.ts`
...
- [x] TASK-stock-8: `views/SuppliesTable` + `views/SupplyForm` + controllers
...
- [x] TASK-stock-9: `views/ExcelImportWizard` with diff preview
...
- [x] TASK-stock-10: Integration tests for supply CRUD, Excel import/export, and alert logic
  ...
  - Deliverable: `apps/api-core/src/application/use-cases/supply/__tests__/supply.integration-spec.ts`
