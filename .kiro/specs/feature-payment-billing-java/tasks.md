...
- [ ] TASK-pay-1: Spring Boot project scaffold (Maven), package structure controller/service/domain/repository/config
  ...
  - Deliverable: `services/payment-service/pom.xml`, `services/payment-service/src/main/java/com/modula/payment/{controller,service,domain,repository,config}/**`, `services/payment-service/src/main/resources/application.yml`
  - Depends on: none
...
- [ ] TASK-pay-2: Configure own database connection (Postgres/Supabase, separate schema) + migrations (Flyway)
  ...
  - Deliverable: `services/payment-service/src/main/resources/application.yml` (datasource config), `services/payment-service/src/main/resources/db/migration/V1__init.sql`
...
- [ ] TASK-pay-3: JPA entities `Payment`, `Refund`, `Receipt`, `AuditLog` + Flyway schema
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/domain/{Payment,Refund,Receipt,AuditLog}.java`, `services/payment-service/src/main/resources/db/migration/V2__entities.sql`
...
- [ ] TASK-pay-4: Audit log aspect — `@Audited` annotation + AOP interceptor
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/domain/AuditLog.java` (if not yet complete), `services/payment-service/src/main/java/com/modula/payment/config/AuditAspect.java`, `services/payment-service/src/main/java/com/modula/payment/config/Audited.java`
...
- [ ] TASK-pay-5: PayPal Orders API SDK/REST integration (sandbox first)
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/service/PayPalClient.java`, `services/payment-service/src/main/java/com/modula/payment/config/PayPalConfig.java`
  - Depends on: TASK-pay-1
  - Assigned to: unassigned
...
- [ ] TASK-pay-6: `POST /payments/orders` endpoint — initiate payment with idempotency
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/controller/PaymentController.java`, `services/payment-service/src/main/java/com/modula/payment/service/PaymentService.java`, `services/payment-service/src/test/java/com/modula/payment/service/PaymentServiceTest.java`
...
- [ ] TASK-pay-7: Webhook endpoint `POST /payments/webhooks/paypal` — signature validation + deduplication
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/controller/WebhookController.java`, `services/payment-service/src/main/java/com/modula/payment/service/WebhookService.java`, `services/payment-service/src/test/java/com/modula/payment/service/WebhookServiceTest.java`
...
- [ ] TASK-pay-8: Outgoing webhook to `api-core` notifying payment result
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/service/ApiCoreWebhookClient.java`, `services/payment-service/src/test/java/com/modula/payment/service/ApiCoreWebhookClientTest.java`
...
- [ ] TASK-pay-9: PDF receipt generation (customer + admin) on payment confirmation
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/service/ReceiptService.java`, `services/payment-service/src/main/java/com/modula/payment/service/PdfGenerator.java`, `services/payment-service/src/test/java/com/modula/payment/service/ReceiptServiceTest.java`
  - Depends on: TASK-pay-7
  - Assigned to: unassigned
...
- [ ] TASK-pay-10: Receipt email sending to customer, with retry on failure
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/service/EmailService.java`, `services/payment-service/src/test/java/com/modula/payment/service/EmailServiceTest.java`
...
- [ ] TASK-pay-11: PayPal Refunds API integration
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/service/PayPalRefundClient.java`, `services/payment-service/src/test/java/com/modula/payment/service/PayPalRefundClientTest.java`
...
- [ ] TASK-pay-12: `POST /payments/orders/:ref/refund` endpoint — execute refund with idempotency + audit
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/service/RefundService.java`, `services/payment-service/src/test/java/com/modula/payment/service/RefundServiceTest.java`
...
- [ ] TASK-pay-13: Refund receipt generation + email to customer (atomic)
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/service/ReceiptService.java` (extend), `services/payment-service/src/test/java/com/modula/payment/service/ReceiptServiceTest.java` (extend)
...
- [ ] TASK-pay-14: `GET /payments/:ref/receipt` endpoint
  ...
  - Deliverable: `services/payment-service/src/main/java/com/modula/payment/controller/PaymentController.java` (extend), `services/payment-service/src/test/java/com/modula/payment/controller/PaymentControllerTest.java`
...
- [ ] TASK-pay-15: End-to-end integration test — full payment and refund lifecycle (PayPal sandbox)
  ...
  - Deliverable: `services/payment-service/src/test/java/com/modula/payment/PaymentIntegrationTest.java`
