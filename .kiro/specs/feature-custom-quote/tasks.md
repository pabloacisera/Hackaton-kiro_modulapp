...
- [ ] TASK-quoteB-1: Migration for `quotes` table + `Quote` domain entity + state machine with guards
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/infrastructure/database/migrations/<timestamp>_create_quotes_table.ts`, `apps/api-core/src/modules/quotes/domain/quote.entity.ts`, `apps/api-core/src/modules/quotes/domain/quote-state-machine.ts`, `apps/api-core/src/modules/quotes/domain/quote-state-machine.spec.ts`
  - Depends on: none
...
- [ ] TASK-quoteB-2: `POST /quotes` endpoint + incomplete data discard + admin notification + confirmation email
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/interface/http/create-quote.controller.ts`, `apps/api-core/src/modules/quotes/interface/http/dto/create-quote.dto.ts`, `apps/api-core/src/modules/quotes/application/create-quote.use-case.ts`, `apps/api-core/src/modules/quotes/application/create-quote.use-case.spec.ts`, `apps/api-core/src/modules/quotes/interface/http/routes.ts`
...
- [ ] TASK-quoteB-3: `PATCH /quotes/:id/present` endpoint (admin quotes)
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/interface/http/present-quote.controller.ts`, `apps/api-core/src/modules/quotes/interface/http/dto/present-quote.dto.ts`, `apps/api-core/src/modules/quotes/application/present-quote.use-case.ts`, `apps/api-core/src/modules/quotes/application/present-quote.use-case.spec.ts`
  - Depends on: TASK-quoteB-1
  - Assigned to: unassigned
...
- [ ] TASK-quoteB-4: Signed one-time-use token generation (JWT) for accept/reject
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/application/token.service.ts`, `apps/api-core/src/modules/quotes/application/token.service.spec.ts`
  - Depends on: TASK-quoteB-1
  - Assigned to: unassigned
...
- [ ] TASK-quoteB-5: Quote email with accept/reject buttons (deep link with token)
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/application/send-quote-email.use-case.ts`, `apps/api-core/src/modules/quotes/application/send-quote-email.use-case.spec.ts`, `apps/api-core/src/modules/quotes/infrastructure/email/templates/quote-presented.template.ts`
...
- [ ] TASK-quoteB-6: Accept + Reject endpoints with token verification (structurally identical)
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/interface/http/accept-quote.controller.ts`, `apps/api-core/src/modules/quotes/interface/http/reject-quote.controller.ts`, `apps/api-core/src/modules/quotes/application/process-quote-response.use-case.ts`, `apps/api-core/src/modules/quotes/application/process-quote-response.use-case.spec.ts`
...
- [ ] TASK-quoteB-7: Admin notification on rejection
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/application/notify-admin-on-rejection.use-case.ts`, `apps/api-core/src/modules/quotes/application/notify-admin-on-rejection.use-case.spec.ts`
...
- [ ] TASK-quoteB-8: Integration with payment-service to generate payment link on accept
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/application/initiate-payment.use-case.ts`, `apps/api-core/src/modules/quotes/application/initiate-payment.use-case.spec.ts`, `apps/api-core/src/modules/quotes/infrastructure/payment/payment-gateway.adapter.ts`
  - Depends on: TASK-quoteB-6
  - Assigned to: unassigned
...
- [ ] TASK-quoteB-9: Webhook endpoint `POST /api/quotes/webhooks/payment-result`
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/interface/http/payment-result-webhook.controller.ts`, `apps/api-core/src/modules/quotes/interface/http/dto/payment-result-webhook.dto.ts`, `apps/api-core/src/modules/quotes/application/process-payment-result.use-case.ts`, `apps/api-core/src/modules/quotes/application/process-payment-result.use-case.spec.ts`
...
- [ ] TASK-quoteB-10: Expiration jobs — quote response (48h) + payment deadline (24h)
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/infrastructure/jobs/quote-expiration-check.job.ts`, `apps/api-core/src/modules/quotes/infrastructure/jobs/quote-payment-expiration-check.job.ts`, `apps/api-core/src/modules/quotes/infrastructure/jobs/quote-expiration-check.spec.ts`, `apps/api-core/src/modules/quotes/infrastructure/jobs/quote-payment-expiration-check.spec.ts`
...
- [ ] TASK-quoteB-11: Archive endpoint + admin listing with filters/search/pagination
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/interface/http/archive-quote.controller.ts`, `apps/api-core/src/modules/quotes/interface/http/list-quotes.controller.ts`, `apps/api-core/src/modules/quotes/interface/http/dto/list-quotes.dto.ts`, `apps/api-core/src/modules/quotes/application/archive-quote.use-case.ts`, `apps/api-core/src/modules/quotes/application/list-quotes.use-case.ts`, `apps/api-core/src/modules/quotes/application/archive-quote.use-case.spec.ts`, `apps/api-core/src/modules/quotes/application/list-quotes.use-case.spec.ts`
  - Depends on: TASK-quoteB-1
  - Assigned to: unassigned
...
- [ ] TASK-quoteB-14: Admin notification on payment completion + delivery timer start
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/application/notify-payment-completed.use-case.ts`, `apps/api-core/src/modules/quotes/application/notify-payment-completed.use-case.spec.ts`
...
- [ ] TASK-quoteB-integration: Integration test for full quote lifecycle
  ...
  - Deliverable: `apps/api-core/src/modules/quotes/__tests__/quotes.integration-spec.ts`
